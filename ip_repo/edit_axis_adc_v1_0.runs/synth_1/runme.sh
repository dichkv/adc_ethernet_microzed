...
HD_PWD='/home/kdich/workspace/zynq/vivado/7020/ip_repo/edit_axis_adc_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_adc_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_adc_v1_0.tcl
