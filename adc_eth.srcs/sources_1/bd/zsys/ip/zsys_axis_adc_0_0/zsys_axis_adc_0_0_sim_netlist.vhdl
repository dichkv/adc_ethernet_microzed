...
-- Date        : Sat Feb 23 13:39:16 2019
-- Host        : kdichpc running 64-bit Ubuntu 16.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/kdich/workspace/zynq/vivado/7010/adc_eth/adc_eth.srcs/sources_1/bd/zsys/ip/zsys_axis_adc_0_0/zsys_axis_adc_0_0_sim_netlist.vhdl
...
entity zsys_axis_adc_0_0_axis_adc_v1_0_M00_AXIS is
  port (
  ...
  attribute ORIG_REF_NAME of zsys_axis_adc_0_0_axis_adc_v1_0_M00_AXIS : entity is "axis_adc_v1_0_M00_AXIS";
end zsys_axis_adc_0_0_axis_adc_v1_0_M00_AXIS;

architecture STRUCTURE of zsys_axis_adc_0_0_axis_adc_v1_0_M00_AXIS is
  ...
  signal data_fifo_reg_i_7_n_0 : STD_LOGIC;
  ...
  signal \v_write_pointer[8]_i_2_n_0\ : STD_LOGIC;
  signal \v_write_pointer[8]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of data_fifo_reg_i_5 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of data_fifo_reg_i_7 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \v_read_pointer[0]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \v_read_pointer[7]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \v_read_pointer[8]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \v_write_pointer[0]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \v_write_pointer[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \v_write_pointer[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \v_write_pointer[8]_i_3\ : label is "soft_lutpair2";
begin
...
data_fifo_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1010101010101000"
        ...
        port map (
      I0 => mst_exec_state(0),
      I1 => axis_tlast_delay_i_1_n_0,
      I2 => mst_exec_state(1),
      I3 => sel0(1),
      I4 => data_fifo_reg_i_4_n_0,
...
data_fifo_reg_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\v_read_pointer[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\v_write_pointer[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I1 => \v_write_pointer[8]_i_4_n_0\,
      I2 => \v_write_pointer_reg__0\(7),
      O => p_0_in(7)
    );
\v_write_pointer[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"77F7"
    )
        port map (
...
\v_write_pointer[8]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zsys_axis_adc_0_0_axis_adc_v1_0 is
  port (
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    m00_axis_tvalid : out STD_LOGIC;
    m00_axis_tlast : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zsys_axis_adc_0_0_axis_adc_v1_0 : entity is "axis_adc_v1_0";
end zsys_axis_adc_0_0_axis_adc_v1_0;

architecture STRUCTURE of zsys_axis_adc_0_0_axis_adc_v1_0 is
begin
axis_adc_v1_0_M00_AXIS_inst: entity work.zsys_axis_adc_0_0_axis_adc_v1_0_M00_AXIS
     port map (
      irq => irq,
...
entity zsys_axis_adc_0_0 is
  ...
  attribute NotValidForBitStream of zsys_axis_adc_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zsys_axis_adc_0_0 : entity is "zsys_axis_adc_0_0,axis_adc_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of zsys_axis_adc_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of zsys_axis_adc_0_0 : entity is "axis_adc_v1_0,Vivado 2018.2";
end zsys_axis_adc_0_0;

architecture STRUCTURE of zsys_axis_adc_0_0 is
...
begin
U0: entity work.zsys_axis_adc_0_0_axis_adc_v1_0
     port map (
      irq => irq,
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
