...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_adc_0, and set properties
  set axis_adc_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_adc:1.0 axis_adc_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dmac_0_m_dest_axi [get_bd_intf_pins axi_dmac_0/m_dest_axi] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_adc_0_M00_AXIS [get_bd_intf_pins axi_dmac_0/s_axis] [get_bd_intf_pins axis_adc_0/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_adc_0_M00_AXIS] [get_bd_intf_pins axis_adc_0/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_dmac_0/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins axis_adc_0/wr_ena]
  ...
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports nSS] [get_bd_pins axi_quad_spi_0/ss_o]
  connect_bd_net -net axis_adc_0_irq [get_bd_pins axis_adc_0/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net io1_i_0_1 [get_bd_ports MISO] [get_bd_pins axi_quad_spi_0/io1_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dmac_0/m_dest_axi_aclk] [get_bd_pins axi_dmac_0/s_axi_aclk] [get_bd_pins axi_dmac_0/s_axis_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_adc_0/m00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dmac_0/m_dest_axi_aresetn] [get_bd_pins axi_dmac_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_adc_0/m00_axis_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net wr_clk_0_1 [get_bd_ports wr_clk] [get_bd_pins axis_adc_0/wr_clk] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net wr_data_0_1 [get_bd_ports wr_data] [get_bd_pins axis_adc_0/wr_data] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net wr_sync_0_1 [get_bd_ports wr_sync] [get_bd_pins axis_adc_0/wr_sync] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_dmac_0/m_dest_axi] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_DDR_LOWOCM] SEG_processing_system7_0_GP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces axi_dmac_0/m_dest_axi] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_IOP] SEG_processing_system7_0_GP0_IOP
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces axi_dmac_0/m_dest_axi] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_M_AXI_GP0] SEG_processing_system7_0_GP0_M_AXI_GP0
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces axi_dmac_0/m_dest_axi] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_QSPI_LINEAR] SEG_processing_system7_0_GP0_QSPI_LINEAR
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dmac_0/s_axi/axi_lite] SEG_axi_dmac_0_axi_lite
