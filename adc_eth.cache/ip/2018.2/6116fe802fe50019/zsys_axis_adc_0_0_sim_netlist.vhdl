...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axis_adc_v1_0_M00_AXIS is
  ...
  signal v_write_pointer_reg : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute SOFT_HLUTNM of \mst_exec_state[0]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \read_pointer[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_pointer[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_pointer[8]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \v_write_pointer[2]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \v_write_pointer[6]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \v_write_pointer[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \v_write_pointer[8]_i_4\ : label is "soft_lutpair6";
begin
...
data_fifo_reg_0_63_0_2: unisim.vcomponents.RAM64M
     port map (
      ...
      ADDRD(5 downto 0) => v_write_pointer_reg(5 downto 0),
      DIA => wr_data(0),
      DIB => wr_data(1),
      DIC => wr_data(2),
      DID => '0',
...
data_fifo_reg_0_63_0_2_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
data_fifo_reg_0_63_0_2_i_3: unisim.vcomponents.LUT6
    generic map(
...
mst_wr_state_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => data_fifo_reg_0_63_0_2_i_3_n_0,
...
\v_write_pointer[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
        ...
        port map (
      I0 => data_fifo_reg_0_63_0_2_i_3_n_0,
...
\v_write_pointer[8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
