...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axis_adc_v1_0_M00_AXIS is
  ...
  attribute SOFT_HLUTNM of rx_done_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \v_read_pointer[0]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \v_read_pointer[0]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \v_read_pointer[7]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \v_write_pointer[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \v_write_pointer[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \v_write_pointer[8]_i_2\ : label is "soft_lutpair3";
begin
...
\FSM_onehot_mst_exec_state[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => mst_exec_state(1),
      I3 => mst_exec_state(0),
      I4 => \FSM_onehot_mst_exec_state[2]_i_2_n_0\,
      O => \FSM_onehot_mst_exec_state[2]_i_1_n_0\
    );
\FSM_onehot_mst_exec_state[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0008FFFF"
    )
        port map (
