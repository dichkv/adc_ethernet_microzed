...
set rc [catch {
  ...
  add_files -quiet /home/kdich/workspace/zynq/vivado/7010/adc_eth/adc_eth.runs/synth_1/zsys_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top zsys_wrapper -part xc7z010clg400-1
  set_param project.isImplRun false
  write_hwdef -force -file zsys_wrapper.hwdef
