...
HD_PWD='/home/kdich/workspace/zynq/vivado/7010/adc_eth/adc_eth.runs/zsys_axis_adc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_axis_adc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_axis_adc_0_0.tcl
